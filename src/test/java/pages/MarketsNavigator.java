...
public class MarketsNavigator {
    ...
    @Step("Открытие выпадающего меню Markets")
    ...
    @Step("Переход на главную страницу Markets")
    ...
    @Step("Переход на страницу Shares")
    ...
    @Step("Переход на страницу Forex")
    ...
    @Step("Переход на страницу Indices")
    ...
    @Step("Переход на страницу Commodities")
    ...
    @Step("Переход на страницу Cryptocurrencies")
    ...
    @Step("Переход на страницу Market Analysis")
